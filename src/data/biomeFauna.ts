...
export const BIOME_FAUNA: Record<BiomeId, BiomeFaunaProfile> = {
  "temperate-rainforest": {
    ...
    spawns: [
      ...
      fauna({ id: "roosevelt-elk", role: "deer", label: "Roosevelt elk", kind: "caribou", motion: "ground", anchor: [6.0, -2.15], scale: 0.88, speed: 0.5, radius: [0.8, 0.5], primary: "#715037", secondary: "#d0ae7e", scientificName: "Cervus canadensis roosevelti", category: "Forest ungulate", habitat: "Old-growth forest openings", ecologicalBeat: "Browses a quiet edge beneath the old-growth canopy." }),
      fauna({ id: "banana-slug", role: "frog", label: "Banana slug", kind: "slug", motion: "ground", anchor: [4.8, -3.45], scale: 0.62, speed: 0.12, radius: [0.32, 0.18], primary: "#d9bf42", secondary: "#765d22", scientificName: "Ariolimax columbianus", category: "Forest decomposer", habitat: "Mossy forest floor", ecologicalBeat: "Recycles fallen leaves into the wet forest soil." }),
      fauna({ id: "river-otter", role: "fish", label: "North American river otter", kind: "otter", motion: "river", anchor: [-0.55, 3.65], scale: 0.7, speed: 0.54, radius: [0.42, 1.25], height: -0.04, primary: "#5a4435", secondary: "#bca17a", scientificName: "Lontra canadensis", category: "River mammal", habitat: "Cold forest stream", ecologicalBeat: "Slides between bank cover and the clear trout run." }),
  ...
  "desert-oasis": {
    ...
    spawns: [
      ...
      fauna({ id: "javelina", role: "deer", label: "Javelina (collared peccary)", kind: "javelina", motion: "ground", anchor: [-6.2, 2.75], scale: 0.64, speed: 0.48, radius: [0.65, 0.38], primary: "#53483d", secondary: "#d7c7a2", scientificName: "Pecari tajacu", category: "Desert social mammal", habitat: "Mesquite and wash corridors", ecologicalBeat: "Moves a small family group between shade and scarce water." }),
  ...
  savanna: {
    ...
    spawns: [
      ...
      fauna({ id: "warthog", role: "rabbit", label: "Common warthog", kind: "warthog", motion: "ground", anchor: [5.8, -2.9], scale: 0.58, speed: 0.48, radius: [0.65, 0.38], primary: "#6e6354", secondary: "#d9c9a9", scientificName: "Phacochoerus africanus", category: "Savanna omnivore", habitat: "Short-grass waterhole margin", ecologicalBeat: "Kneels to graze close to the waterhole." }),
  ...
  "arctic-tundra": {
    ...
    spawns: [
      ...
      fauna({ id: "muskox", role: "deer", label: "Muskox", kind: "muskox", motion: "ground", anchor: [5.8, -2.75], scale: 0.74, speed: 0.28, radius: [0.65, 0.4], primary: "#40362f", secondary: "#b59c75", scientificName: "Ovibos moschatus", category: "Arctic grazer", habitat: "Wind-scoured tundra ridge", ecologicalBeat: "Holds a tight line against the polar wind." }),
  ...
  "amazon-floodplain": {
    ...
    spawns: [
      ...
      fauna({ id: "jaguar", role: "deer", label: "Jaguar", kind: "feline", motion: "ground", anchor: [-6.3, 2.7], scale: 0.74, speed: 0.36, radius: [0.65, 0.38], primary: "#c99445", secondary: "#32291e", scientificName: "Panthera onca", category: "Floodplain predator", habitat: "Seasonal forest edge", ecologicalBeat: "Moves quietly where the floodplain meets dry forest." }),
  ...
  "alpine-meadow": {
    ...
    spawns: [
      ...
      fauna({ id: "himalayan-marmot", role: "rabbit", label: "Himalayan marmot", kind: "marmot", motion: "ground", anchor: [5.85, -2.7], scale: 0.56, speed: 0.32, radius: [0.45, 0.28], primary: "#866a50", secondary: "#d6b990", scientificName: "Marmota himalayana", category: "Alpine burrower", habitat: "Sunny alpine meadow", ecologicalBeat: "Keeps watch above a warm burrow colony." }),
      fauna({ id: "blue-sheep", role: "deer", label: "Himalayan blue sheep", kind: "musk-deer", motion: "ground", anchor: [-5.9, -3.0], scale: 0.68, speed: 0.44, radius: [0.65, 0.4], primary: "#7c8790", secondary: "#d8d1bf", scientificName: "Pseudois nayaur", category: "Alpine grazer", habitat: "Rocky meadow slope", ecologicalBeat: "Threads a sure-footed path across the open slope." }),
  ...
  "coral-reef": {
    ...
    spawns: [
      ...
      fauna({ id: "giant-clam", role: "fish", label: "Giant clam", kind: "clam", motion: "benthic", anchor: [4.9, -3.4], scale: 0.76, speed: 0.02, radius: [0.24, 0.18], height: 0.12, primary: "#4ca5b0", secondary: "#523f83", scientificName: "Tridacna gigas", category: "Reef bivalve", habitat: "Sunlit coral shelf", ecologicalBeat: "Filters water while symbiotic algae harvest sunlight." }),
